...
export const ACTION_LABEL: Record<string, string> = {
  ...
  "space.member_added": "Space-Zugriff erteilt",
  "space.member_role_changed": "Space-Rolle geändert",
  "space.member_removed": "Space-Zugriff entzogen",
  "page.access_changed": "Seitensichtbarkeit geändert",
  "page.member_added": "Seitenzugriff erteilt",
  "page.member_role_changed": "Seitenrolle geändert",
  "page.member_removed": "Seitenzugriff entzogen",
